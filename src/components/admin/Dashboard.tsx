...
export default function Dashboard() {
  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      try {
        const [statsData, recentOrders, salesData, visitorData] =
          await Promise.all([
        ...
        {cards.map((card) => (
          <div key={card.title} className="p-6 bg-white rounded-lg shadow">
            <div className="flex items-center justify-between">
              ...
              <div
                className={`bg-${card.colorClass.split(" ")[0]} p-2 rounded-lg`}
              >
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <div className="p-6 bg-white rounded-lg shadow">
            ...
            <div className="flex items-center space-x-4">
              <button
                className={`text-sm font-medium ${
                  chartType === "sales" ? "text-gray-900" : "text-gray-400"
                } hover:text-gray-900`}
              ...
              <button
                className={`text-sm font-medium ${
                  chartType === "visitors" ? "text-gray-900" : "text-gray-400"
                } hover:text-gray-900`}
          ...
          <div className="h-80">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart
                data={
                  chartType === "sales" ? stats.salesData : stats.visitorData
                }
              >
        ...
        <div className="p-6 bg-white rounded-lg shadow">
          <div className="flex items-center justify-between mb-4">
            ...
            <button className="flex items-center text-sm font-medium text-indigo-600 hover:text-indigo-900">
